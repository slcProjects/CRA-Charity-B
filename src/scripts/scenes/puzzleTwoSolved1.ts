...
export default class PuzzleTwoSolved1 extends Phaser.Scene {

    constructor() {
      super({ key: 'PuzzleTwoSolved1' })
    ...
    create()
    {
      ...
      const image = this.add.image(0, 0, 'background');
        ...
        const nextButton = new Button(this,550,340,'Next',"PuzzleTwoSolved2");

        const previousButton = new Button(this,100,340,'Go Back',"PuzzleTwo");
        ...
        const martianOne = this.add.image(700,400, 'martianThree');
